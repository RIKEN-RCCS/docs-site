...
| `qwen3.8-27b`         | 27B        | 256K           | Compact model that accepts image input         | [Qwen/Qwen3.8-27B](https://huggingface.co/Qwen/Qwen3.8-27B){ target="_blank" rel="noopener" } |
| `kimi-k2.6`           | 1T         | 256K           | Large-scale model                              | [moonshotai/Kimi-K2.6](https://huggingface.co/moonshotai/Kimi-K2.6){ target="_blank" rel="noopener" } |
| `glm-5.2`             | 753B       | 1M             | Model for long contexts                        | [zai-org/GLM-5.2](https://huggingface.co/zai-org/GLM-5.2){ target="_blank" rel="noopener" } |
| `glm-5.3`             | 753B       | 1M             | Newer version of `glm-5.2`                     | [zai-org/GLM-5.3](https://huggingface.co/zai-org/GLM-5.3){ target="_blank" rel="noopener" } |
| `glm-5.3-flash`       | 320B       | 1M             | Model for long contexts and image input        | [zai-org/GLM-5.3-Flash](https://huggingface.co/zai-org/GLM-5.3-Flash){ target="_blank" rel="noopener" } |
| `deepseek-v4.1-flash` | 552B+196B  | 1M             | Suited to long inputs; accepts image input     | [deepseek-ai/DeepSeek-V4.1-Flash](https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash){ target="_blank" rel="noopener" } |
