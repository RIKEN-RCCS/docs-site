...
| `qwen3.8-27b` | 27B        | 256K           | Model that accepts image input                 | [Qwen/Qwen3.8-27B](https://huggingface.co/Qwen/Qwen3.8-27B){ target="_blank" rel="noopener" } |
...
In addition to text, `qwen3.8-27b` also accepts image input. The other models are text-only.
