...
標準で利用できるストレージ容量は、ホームディレクトリがユーザあたり5 GB、グループディレクトリがグループあたり50 GBです。標準容量を超えてストレージ容量を追加する場合は、追加容量に応じた課金が必要です。ストレージ容量の増量を希望する場合は、[Zendesk](https://support.r-ccs.riken.jp/hc/ja?brand_id=5378545411486)からリクエストしてください。
