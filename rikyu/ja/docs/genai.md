...
| `qwen3.8-27b` | 27B          | 256K           | 画像入力に対応するモデル                 | [Qwen/Qwen3.8-27B](https://huggingface.co/Qwen/Qwen3.8-27B){ target="_blank" rel="noopener" } |
...
`qwen3.8-27b`は、テキストに加えて画像入力にも対応しています。他のモデルはテキストのみです。
