...
| `qwen3.8-27b`         | 27B          | 256K           | 画像入力に対応する小型モデル             | [Qwen/Qwen3.8-27B](https://huggingface.co/Qwen/Qwen3.8-27B){ target="_blank" rel="noopener" } |
| `kimi-k2.6`           | 1T           | 256K           | 大規模モデル                             | [moonshotai/Kimi-K2.6](https://huggingface.co/moonshotai/Kimi-K2.6){ target="_blank" rel="noopener" } |
| `glm-5.2`             | 753B         | 1M             | 長いコンテキストを扱えるモデル           | [zai-org/GLM-5.2](https://huggingface.co/zai-org/GLM-5.2){ target="_blank" rel="noopener" } |
| `glm-5.3`             | 753B         | 1M             | `glm-5.2`の新バージョン                  | [zai-org/GLM-5.3](https://huggingface.co/zai-org/GLM-5.3){ target="_blank" rel="noopener" } |
| `glm-5.3-flash`       | 320B         | 1M             | 長いコンテキストと画像入力を扱えるモデル | [zai-org/GLM-5.3-Flash](https://huggingface.co/zai-org/GLM-5.3-Flash){ target="_blank" rel="noopener" } |
| `deepseek-v4.1-flash` | 552B+196B    | 1M             | 長い入力に適した、画像入力に対応するモデル | [deepseek-ai/DeepSeek-V4.1-Flash](https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash){ target="_blank" rel="noopener" } |
| `kimi-k3`             | 2.8T         | 928K           | 最大規模のモデル                         | [moonshotai/Kimi-K3](https://huggingface.co/moonshotai/Kimi-K3){ target="_blank" rel="noopener" } |

パラメータ数は総パラメータ数です。`qwen3.8-27b`を除く各モデルはMoE（Mixture of Experts）モデルであり、1トークンの生成に実際に使われるパラメータ数はこれより少なくなります。コンテキスト長は、本サービスで入力に指定できるトークン数の上限であり、モデル本来の上限とは異なる場合があります。

いずれのモデルも、推論（reasoning）とFunction Callingに対応しています。

`qwen3.8-27b`、`glm-5.3-flash`、`deepseek-v4.1-flash`は、テキストに加えて画像入力にも対応しています。他のモデルはテキストのみです。
